...
boxplot(dat3$DecimalTime~dat3$Description.of.Activity, main="Parking Time by Activity",ylab="Interview Counts", col = c("red", "blue", "green", "purple", "orange", "gray", "lightgreen"), xaxt="n", xlab="")
axis(1, labels = FALSE)
