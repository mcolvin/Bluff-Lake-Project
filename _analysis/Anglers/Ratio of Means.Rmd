...
datMar<-subset(dat, Month== "March")
MeanofRatiosMar<-sum(datMar$CPUE)/7
MeanofRatiosMar*31
...
datApril<-subset(dat, Month== "April")
MeanofRatiosApr<-sum(datApril$CPUE)/7
MeanofRatiosApr*30
# #May
...
datMay<-subset(dat, Month== "May")
MeanofRatiosMay<-sum(datMay$CPUE)/7
MeanofRatiosMay*31
# #June
...
datJune<-subset(dat, Month== "June")
MeanofRatiosJune<-sum(datJune$CPUE)/7
MeanofRatiosJune*30
# #July
...
datJuly<-subset(dat, Month== "July")
MeanofRatiosJuly<-sum(datJuly$CPUE)/7
MeanofRatiosJuly*31
# #August
...
datAugust<-subset(dat, Month== "August")
MeanofRatiosAug<-sum(datAugust$CPUE)/7
MeanofRatiosAug*31
