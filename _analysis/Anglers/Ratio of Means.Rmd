...
ExpandedHours$Days<-c(31,30,31,30,31,31,30,31,31,31,30)
...
ExpandedHours2$Days<-c(31,30,31,30,31,31,30,31,31,31,30)
...
ggplot(AllAnglers, aes(fill=Group2, x = Month, y=Total), las=2)+
