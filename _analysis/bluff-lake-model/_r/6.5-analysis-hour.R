...
#   plot(Q_bl~doy,discharge_year,ylab="Lake volume",las=1,
#        main=years[i], xlim=c(0,366))}

#1990-2019 looks good 
...
for(i in 1:length(years)){
  ...
  dateTime<-seq(discharge_year$dateTime[1],discharge_year$dateTime[1]+days(364), "1 hour")
