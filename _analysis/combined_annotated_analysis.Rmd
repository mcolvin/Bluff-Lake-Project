...
#Utilities
dat2<- read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_0cms_discharge/9Boards.csv")
...
dat2$Utility<- ((dat2$RampUt)*.5) + ((dat2$AngUt)*.5)+((dat2$FishUt)) +
  ((dat2$WBUt)) + ((dat2$WFUt))
...
write.csv(dat2, "~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_0cms_discharge/9BoardsUtilities.csv")
...
One<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_0cms_discharge/1BoardsUtilities.csv")
One$Discharge<- rep("0 cms",nrow(One))
Two<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_2.825cms_discharge/1BoardsUtilities.csv")
Two$Discharge<- rep("2.825 cms",nrow(Two))
Three<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_5.65cms_discharge/1BoardsUtilities.csv")
Three$Discharge<- rep("5.65 cms",nrow(Three))
Four<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_8.475cms_discharge/1BoardsUtilities.csv")
Four$Discharge<- rep("8.475 cms",nrow(Four))
Five<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_11.3cms_discharge/1BoardsUtilities.csv")
Five$Discharge<- rep("11.3 cms",nrow(Five))
Six<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_14.125cms_discharge/1BoardsUtilities.csv")
Six$Discharge<- rep("14.125 cms",nrow(Six))
Seven<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_16.95cms_discharge/1BoardsUtilities.csv")
Seven$Discharge<- rep("16.95 cms",nrow(Seven))

data <- rbind(One, Two, Three, Four, Five, Six, Seven)

ggplot(data, aes(day, mUtility, group = Discharge, color = Discharge)) +
  geom_line( )+
...
One<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_0cms_discharge/5BoardsUtilities.csv")
One$Discharge<- rep("0 cms",nrow(One))
Two<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_2.825cms_discharge/5BoardsUtilities.csv")
Two$Discharge<- rep("2.825 cms",nrow(Two))
Three<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_5.65cms_discharge/5BoardsUtilities.csv")
Three$Discharge<- rep("5.65 cms",nrow(Three))
Four<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_8.475cms_discharge/5BoardsUtilities.csv")
Four$Discharge<- rep("8.475 cms",nrow(Four))
Five<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_11.3cms_discharge/5BoardsUtilities.csv")
Five$Discharge<- rep("11.3 cms",nrow(Five))
Six<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_14.125cms_discharge/5BoardsUtilities.csv")
Six$Discharge<- rep("14.125 cms",nrow(Six))
Seven<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_16.95cms_discharge/5BoardsUtilities.csv")
Seven$Discharge<- rep("16.95 cms",nrow(Seven))
...
Five$Discharge<- rep("11.3 cms",nrow(Five))
Six<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_14.125cms_discharge/9BoardsUtilities.csv")
Six$Discharge<- rep("14.125 cms",nrow(Six))
Seven<-read.csv("~/GitHub/Bluff-Lake-Project/_analysis/noxubee-discharge-states/paddlefish-discharges/weekly_16.95cms_discharge/9BoardsUtilities.csv")
Seven$Discharge<- rep("16.95 cms",nrow(Seven))
...
ggplot(data, aes(day, mUtility, group = Discharge, color = Discharge)) +
  geom_line( )+
  labs(title="Utility of Paddlefish Discharges 9 Boards by month",
       y="Utility",
       x="Day of Month")+
  scale_colour_discrete(
            breaks=c("0 cms", "2.825 cms", "5.65 cms", "8.475 cms", "11.3 cms", 
