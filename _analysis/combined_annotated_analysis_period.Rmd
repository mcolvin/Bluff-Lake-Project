...
plot(FitG4~Date.Time, data, type="l", col="red", ylim=c(68.2,69.3), 
     main="GAM Model 4", xlab="Date", ylab="Water Surface Elevation")
par(new=T)
plot(WSE~Date.Time, data, type="l", col="blue", ylim=c(68.2,69.3),ylab=NA, xlab=NA)
...
dat$Discharge_cms<-na.approx(dat$Discharge_cms)
...
for (i in 1:length(combos))
    ...
    fish3$volume[first_day_row_indx]<-257558197
    ## INITIAL VOLUME AT THE FIRST OF THE period-
    #  0-257558197 1-258323648 2-259113476 3-259651880 4-259786359 
    #  5-259909631 6-260121798 7-260439030 8-260989054 9-261496613
