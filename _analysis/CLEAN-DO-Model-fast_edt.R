...
for(i in 1:nrow(combos))
    ...
    big_data4<-big_data3
    big_data4$DawnDO_Mod<-ifelse(is.na(big_data4$DawnDO_Mod), 
                                 mean(big_data4$DawnDO_Mod, na.rm=T), big_data4$DawnDO_Mod)
    ...
    fwrite(combos,"_do-outputs/combos-fast2.csv")
    print(i/nrow(combos))
    }
proc.time()-ptm
